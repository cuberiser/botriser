...
class misc(commands.Cog):
    ...
    async def playing(self, ctx, *, playmessage):
        await bot.change_presence(activity=discord.Activity(
            type=discord.ActivityType.playing, name=f'{playmessage}'))
    ...
    async def comp(self, ctx, *, compmessage):
        await bot.change_presence(activity=discord.Activity(
            type=discord.ActivityType.competing, name=f'{compmessage}'))
    ...
    async def listening(self, ctx, *, listmessage):
        await bot.change_presence(activity=discord.Activity(
            type=discord.ActivityType.listening, name=f'{listmessage}'))
    ...
    async def watching(self, ctx, *, watchmessage):
        await bot.change_presence(activity=discord.Activity(
            type=discord.ActivityType.watching, name=f'{watchmessage}'))
